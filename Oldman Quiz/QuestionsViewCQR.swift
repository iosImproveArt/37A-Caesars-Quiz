...
struct QuestionsViewOldman37: View {
    @State var selectedQuestion: Tab4QuestionOldman37 = Tab4QuestionOldman37.list.randomElement()!
            ...
            if isInternetAvailable() {
                ...
                HStack {
                    ...
                    Button {
                        ...
                        selectedQuestion = Tab4QuestionOldman37.list.randomElement()!
                    } label: {
                        Image("tab4.generate")
                    }
...
#Preview {
    ContentViewOldman37(showLoading: false, selectedTab: .questions)
}

struct Tab4QuestionOldman37 {
    let question: String
    let hint1: String
    let hint2: String
    let answer: String
    
    static let list: [Tab4QuestionOldman37] = [
        Tab4QuestionOldman37(
